  ...
  if (sent) return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4">
      <div className="card max-w-md w-full text-center">
        ...
        <p className="text-gray-400 mb-4">If an account exists for {email}, a reset link has been sent.</p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4">
      <form onSubmit={handleSubmit} className="card max-w-md w-full space-y-4">
        ...
        <Link to="/login" className="block text-center text-sm text-gray-400 hover:text-gray-200">Back to Login</Link>
      </form>
    </div>
  );
}
