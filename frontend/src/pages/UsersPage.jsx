  ...
  return (
    <div className="space-y-6">
      <div className="card">
        ...
        <p className="text-sm text-gray-400">Manage user access and roles. First registered user is automatically admin.</p>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-800">
                {['Name', 'Email', 'Role', 'Verified', 'Registered', 'Change Role'].map((h) => (
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <ul className="text-sm text-gray-400 space-y-0.5">
              <li><strong className="text-red-300">Admin</strong> — Full access: setpoints, user management, all reports</li>
              <li><strong className="text-yellow-300">Operator</strong> — View dashboard, acknowledge alerts, generate reports</li>
              <li><strong className="text-blue-300">Viewer</strong> — Read-only dashboard and alerts</li>
            </ul>
          </div>
        </div>
      </div>
