    ...
    <aside className="w-60 bg-gray-900 border-r border-gray-800 flex flex-col h-full flex-shrink-0">
            ...
            <NavLink key={to} to={to} end={end}
              className={({ isActive }) =>
                `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors
                 ${isActive ? 'bg-primary-800/60 text-primary-300' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-800'}`}>
      ...
      <div className="p-3 border-t border-gray-800">
        <div className="flex items-center gap-3 px-3 py-2 mb-1">
          <div className="w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center text-sm font-bold text-gray-200 flex-shrink-0">
        ...
        <button onClick={logout}
          className="flex items-center gap-3 px-3 py-2 w-full text-left rounded-lg text-sm text-gray-400 hover:text-red-400 hover:bg-red-500/10 transition-colors">
