...
import {
  Zap, LayoutDashboard, Bell, FileText, Settings,
  Users, LogOut, Wifi, WifiOff,
} from 'lucide-react';
    ...
    <aside className="w-60 bg-gray-900 border-r border-gray-800 flex flex-col h-full">
      ...
      <div className="p-3 border-t border-gray-800">
        <div className="flex items-center gap-3 px-3 py-2 mb-1">
          <div className="w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center text-sm font-bold text-gray-200">
